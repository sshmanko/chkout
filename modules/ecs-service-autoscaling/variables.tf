...
variable "max_memory_threshold" {
  description = "Threshold for max memory usage"
  default     = "85"
  type        = string
}
variable "min_memory_threshold" {
  description = "Threshold for min memory usage"
  default     = "10"
  type        = string
}

variable "max_memory_evaluation_period" {
  description = "The number of periods over which data is compared to the specified threshold for max memory metric alarm"
  default     = "3"
  type        = string
}
variable "min_memory_evaluation_period" {
  description = "The number of periods over which data is compared to the specified threshold for min memory metric alarm"
  default     = "3"
  type        = string
}

variable "max_memory_period" {
  description = "The period in seconds over which the specified statistic is applied for max memory metric alarm"
  default     = "60"
  type        = string
}
variable "min_memory_period" {
  description = "The period in seconds over which the specified statistic is applied for min memory metric alarm"
  default     = "60"
  type        = string
}
